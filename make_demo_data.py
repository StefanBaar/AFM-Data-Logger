...
# Default: AFM_data/ next to this script (inside the project)
ROOT = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(__file__).parent / "AFM_data"
...
if __name__ == "__main__":
    ...
    print(f"(Set this path in the UI as the root)\n")
    random.seed(42)
